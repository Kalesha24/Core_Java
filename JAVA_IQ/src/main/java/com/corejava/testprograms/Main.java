package com.corejava.testprograms;
...
public class Main {
	public static void main(String[] args) {
		...
		List<Integer> nums = Arrays.asList(1, 2, 3, 3, 4, 3, 2, 5, 6, 1, 7, 7, 8, 9, 9, 10);

		// Print the list
		System.out.println("List elements with duplicates: " + nums);
